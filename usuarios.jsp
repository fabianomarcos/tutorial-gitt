  ...
  <div class="content">
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <p class="man_user"><strong>Manutenção de Usuários </strong></p>
            </blockquote>
          </blockquote>
        </blockquote>
      </blockquote>
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
                <blockquote>
                  <p><a href="cadUsuarios.jsp">Novo<img src="ImagemSite.png" width="40" height="40" alt="Novo" /></a>Imprimir<a href="imprimir_usuarios.jsp"><img src="ImagemSite.png" width="40" height="40" alt="Imprimir" /></a></p>
                  <p>&nbsp;</p>
                  <table width="528" height="84" border="1">
                    <tr bgcolor="#666666" style="font-weight: bold">
                      <td width="56"><a href="usuarios.jsp?ordenacao=codigo">Código</a></td>
                      <td width="121"><a href="usuarios.jsp?ordenacao=usuario">Usuário</a></td>
                      <td width="52">Senha</td>
                      <td width="134">Nível de acesso</td>
                      <td width="57">Alterar</td>
                      <td width="58">Excluir</td>
                    </tr>
                    <%
	try
	{
	...
	%>
                    <tr>
                      ...
                      <td><a href="alteraUsuarios.jsp?codigo=<%=rs.getString("log_codigo")%>&amp;usuario=<%=rs.getString("log_usuario")%>&amp;senha=<%=rs.getString("log_senha")%>&amp;nivelacesso=<%=rs.getString("log_nivelacesso")%>"><img src="ImagemSite.png" width="40" height="40" alt="Alterar" /></a></td>
                      <td><a href="usuarios.jsp?acao=excluir&amp;codigo=<%=rs.getString("log_codigo")%>"><img src="ImagemSite.png" width="40" height="40" alt="Excluir" /></a></td>
                    </tr>
                    <%
		}
	}
