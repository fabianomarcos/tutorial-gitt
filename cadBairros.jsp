...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <li><a href="index.jsp"title="Principal" target="_parent" id="linkUsuario">Principal</a></li>
      <li><a href="bairro.jsp" title="Bairros" target="_parent" id="linkBairro">Bairros</a></li>
    ...
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <p class="man_user">Cadastro de Bairros</p>
              
              <% if(request.getParameter("acao") == null)
			  
			  {
			 %>
              <form action="cadBairros.jsp?acao=gravar" method="post" name="frmInserirBairro" target="_parent" id="frmInserirBairro">
                <p>Código:
                <input name="txtcodigo" type="text" disabled="disabled" class="nome" id="txtcodigo" size="4" />
                </p>
                <p>
                ...
                <p><a href="bairros.jsp">
                  <input name="gravar" type="submit" class="bairros" id="gravar" value="Gravar" />
              ...
              <% }
			     else
			  	{
					...
					{
						response.sendRedirect("cadBairros.jsp");
					}
					else
					{
					try
						...
						st.executeUpdate("insert into bairro(bai_nome)values('"
