    ...
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <p class="man_user">Cadastro de Usuários</p>
              
              <% if(request.getParameter("acao") == null)
			  
			  {
			 %>
              <form action="cadUsuarios.jsp?acao=gravar" method="post" name="frmInserirUsuario" target="_parent" id="frmInserirUsuario">
                <p>Código:
                <input name="txtcodigo" type="text" disabled="disabled" class="usuarios" id="txtcodigo" size="4" />
                </p>
                <p>
                  
                  <label for="txtusuario">Usuário:</label>
                  <input name="txtusuario" type="text" id="txtusuario" size="10" maxlength="10" />
                </p>
                <p>Senha:
                  <input name="txtsenha" type="password" id="txtsenha" size="10" maxlength="10" />
                </p>
                <p>Nível Acesso:
                  <input name="txtnivelacesso" type="text" id="txtnivelacesso" size="3" maxlength="1" />
                </p>
                <p>
                  <a href="usuarios.jsp">
                  <input name="gravar" type="submit" class="usuarios" id="gravar" value="Gravar" />
              ...
              <% }
			     else
			  	{
					...
					{
						response.sendRedirect("cadUsuarios.jsp");
					}
					else
					{
					try
						...
						st.executeUpdate("insert into login(log_usuario,log_senha,log_nivelacesso)values('"
						 +request.getParameter("txtusuario")+"','"
					     +request.getParameter("txtsenha")+"','"
				    	 +request.getParameter("txtnivelacesso")+"')");
