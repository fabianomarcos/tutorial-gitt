    ...
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <p class="man_user">Alteração de BAIRRO</p>
              
              <% if(request.getParameter("acao") == null)
			  
			  {
			 %>
              <form action="alteraBairros.jsp?acao=alterar" method="post" name="frmAlteraBairro" target="_parent" id="frmAlteraBairro">
                <p>Código:
                <input name="txtcodigo" type="text"  class="bairros" id="txtcodigo" value="<%=request.getParameter("codigo")%>" size="4" />
                </p>
                <p>
                  
                  <label for="txtnome">Nome:</label>
                  <input name="txtnome" type="text" id="txtnome" value="<%=request.getParameter("bairro")%>" size="10" maxlength="10" />
                </p>
                <p>
                  <a href="bairros.jsp">
                  <input name="gravar" type="submit" class="bairros" id="gravar" value="Confirmar" />
              ...
              <% }
			     else
			  	{
					...
					{
						response.sendRedirect("alteraBairros.jsp");
					}
					else
					{
					try
						...
						st.executeUpdate("update bairro set bai_nome = '"+request.getParameter("txtnome")+"' where bai_codigo = " +request.getParameter("txtcodigo"));
					
					
					response.sendRedirect("bairros.jsp");
					  }
