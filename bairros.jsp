  ...
  <div class="content">
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <p class="man_user"><strong>Manutenção de Bairro </strong></p>
            </blockquote>
          </blockquote>
        </blockquote>
      </blockquote>
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
                <blockquote>
                  <p><a href="cadBairros.jsp">Novo<img src="ImagemSite.png" width="40" height="40" alt="Novo" /></a>Imprimir<a href="imprimir_bairros.jsp"><img src="ImagemSite.png" width="40" height="40" alt="Imprimir" /></a></p>
                  <p>&nbsp;</p>
                  <table width="528" height="84" border="1">
                    <tr bgcolor="#666666" style="font-weight: bold">
                      <td width="56"><a href="bairros.jsp?ordenacao=codigo">Código</a></td>
                      <td width="121"><a href="bairros.jsp?ordenacao=nome">Bairro</a></td>
	...
	try
	{
		...
		if(request.getParameter("ordenacao") == null)
			...
			rs = st.executeQuery("select * from bairro order by bai_codigo");
	...
	%>
                    <tr>
                      ...
                      <td><a href="alteraBairros.jsp?codigo=<%=rs.getString("bai_codigo")%>&amp;bairro=<%=rs.getString("bai_nome")%>"><img src="ImagemSite.png" alt="Alterar" width="40" height="40" border="0" /></a></td>
                      <td><a href="bairros.jsp?acao=excluir&amp;codigo=<%=rs.getString("bai_codigo")%>"><img src="ImagemSite.png" width="40" height="40" alt="Excluir" /></a></td>
                    </tr>
                    <%
		}
	}
